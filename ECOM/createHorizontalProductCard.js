export const createHorizontalProductCard =(products,
    parentElement) => {
        for (let product of products){
            ...
            oldPrice.classList.add("discount","padding-all-8");
            oldPrice.innerText = `(${product.discount}% OFF)`;
            ...
            quantity.classList.add("count-container","align-center","d-flex","gap");
